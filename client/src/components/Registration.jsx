                ...
                Register
                        ...
                        <div className="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                            <input type="text"
                                ...
                                onChange={e => setUser({ ...user, firstName: e.target.value })} placeholder='First Name' />
                        ...
                        <div className="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                            <input type="text"
                                className="input100"
                                value={user.lastName}
                                onChange={e => setUser({ ...user, lastName: e.target.value })} placeholder='Last Name' />
                        ...
                        <div className="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                            <input type="password"
                                ...
                                onChange={e => setUser({ ...user, confirmPW: e.target.value })} placeholder='Confirm Password' />
                        ...
                        <div className="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                            <input type="number"
                                ...
                                onChange={e => setUser({ ...user, phoneNumber: e.target.value })} placeholder='Phone Number' />
